// common/core_economy.js
/**
 * ============================================================
 * 经济规则: 回收价 / 商店价的统一公式
 * ============================================================
 * 回收区与商店共用同一套定价, 形成"回收 -> 商店"的经济闭环:
 *   回收价 = 奖励档 × 卡牌数值 × 稀有度(卡牌创建时丢失 rare 则取固定 2)
 *   商店价 = 回收价 × 1.5(向上取整)
 * 2026-08-15 level隐藏方案: 奖励档固定(普通2/困难3/直接奖励1), 价格不随层数膨胀
 */

/**
 * 计算一张卡的"理论回收价"
 * @param {number} level - 奖励档(rewardLevel, 固定 1/2/3)
