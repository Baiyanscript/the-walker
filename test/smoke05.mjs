...
// 模拟 useCard 拦截
const slash = createCard("斩击", { level: 2 }) // power16 cost1
...
check("拦截: 16*2*1*2=64", () => assert.equal(dmg, 64))
...
const ener = createCard("快速充能", { level: 2 }) // costAP0 power4
...
check("0费卡: costAP按1算, 4*2*1*3=24", () => assert.equal(dmg2, 24))
